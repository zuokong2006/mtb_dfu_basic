...
#if defined (CY_USING_HAL)
	#define SW2_HAL_PORT_PIN P0_4
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define SW2_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define SW2_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define SW2_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#endif //defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define LED_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t SW2_obj;
#endif //defined (CY_USING_HAL)
